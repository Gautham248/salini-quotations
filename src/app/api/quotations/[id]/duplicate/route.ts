...
export async function POST(
  ...
  const dup = await db.quotation.create({
    data: {
      ...
      shipToName: orig.shipToName,
      shipToAddress: orig.shipToAddress,
      shipToPlace: orig.shipToPlace,
      shipToGstin: orig.shipToGstin,
      deliveryNote: orig.deliveryNote,
      deliveryTerms: orig.deliveryTerms,
      gstNote: orig.gstNote,
      validity: orig.validity,
      paymentTerms: orig.paymentTerms,
      loadingCharges: orig.loadingCharges,
